...
export async function POST(req: Request) {
  try {
    const { name, email, birthDate, phoneNumber } = await req.json()
    ...
    // Safe Birth Date Parsing (Undefined instead of null)
    ...
    if (!accessKey) {
      throw new Error('Access key was not generated by collection hook')
    }
