...
function CheckoutContent() {
  ...
  const handleOrderSubmit = async (
    ...
    try {
      // ==========================================
      // IMPORTANT:
      // Payload shippingAddress fields are:
      // address
      // city
      // phone
      // ==========================================
      ...
      const orderPayload = {
        ...
        // FIX:
        // "street" was wrong.
        // Payload expects "address".
        // Phone is also included here.
        // ------------------------------------------
        ...
        items: cartItems.map((item) => ({
          // IMPORTANT:
          // This should be the actual Payload
          // Product ID, not a hard-coded 1.
         product: item.payloadProductId,
      ...
      // Debug:
      // Browser console mein exact payload check
      // karne ke liye.
      console.log(
        'ORDER PAYLOAD:',
        orderPayload
