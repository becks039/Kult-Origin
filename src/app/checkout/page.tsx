...
// Same shipping logic as Cart page
const shipping =
subtotal > 20000 || cartItems.length === 0
? 0
: 250;
...
const handleOrderSubmit = async (
  ...
  try {
    // ==========================================
    // PAYLOAD CMS ORDER DATA
    // Must match collections/orders.ts exactly
    // ==========================================
    ...
    console.log('ORDER PAYLOAD SENT TO CMS:');
...
if (!isCartLoaded) {
return ( <div className="min-h-screen bg-[#0A0B0D] text-[#E8E2D6] font-mono p-6 text-center flex items-center justify-center tracking-widest text-xs">
LOADING CHECKOUT PROTOCOL... </div>
);
}
...
return ( <div className="relative min-h-screen bg-[#0A0B0D] text-[#E8E2D6] font-mono selection:bg-[#D4AF37] selection:text-black overflow-x-hidden">
...
return (
<Suspense
fallback={ <div className="min-h-screen bg-[#0A0B0D] text-[#E8E2D6] font-mono p-6 text-center flex items-center justify-center tracking-widest text-xs">
LOADING CHECKOUT PROTOCOL... </div>
}
